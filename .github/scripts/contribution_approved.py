...
# ["Company Name", "_No response_", "Internship Title", "_No response_", "Link to Internship Posting", "example.com/link/to/posting", "Location", "Toronto, ON | Richmond, BC | Remote"]
LINES = {
    "url": 1,
    "company_name": 3,
    "title": 5,
